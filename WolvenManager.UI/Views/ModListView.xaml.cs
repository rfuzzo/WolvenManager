...
namespace WolvenManager.UI.Views
{
    ...
    public partial class ModListView : ReactiveUserControl<ModListViewModel>
    {
        public ModListView()
        {
            ...
            this.WhenActivated(disposables =>
            {
                this.OneWayBind(ViewModel,
                        viewModel => viewModel.ModArchiveCollection,
                ...
                this.BindCommand(ViewModel,
                        viewModel => viewModel.RefreshModCommand,
        ...
        private void OnRowDropped(object sender, GridRowDroppedEventArgs e)
        {
            ...
            var targetRecord = model.ModArchiveCollection[(int)e.TargetRecord];

            ModList.BeginInit();

            var translation = model.ModArchiveCollection.Select(_ => _.LoadOrder).OrderBy(_ => _).ToList();
            var draggingRecords = records.Select(_ => (_ as ArchiveViewModel).LoadOrder).ToList();
            ...
            foreach (var modViewModel in model.ModArchiveCollection)
            {
